...
/**
 * <strong>ServletRequestScope</strong> is a specialized <code>Scope</code>
...
public class ServletRequestScope extends BaseScope {
    ...
    /**
     * Construct a ServletRequestScope associated with the specified
     * ServletRequest.
     *
     * @param servletRequest The associated ServletRequest
     */
    public ServletRequestScope(ServletRequest servletRequest) {
    ...
    public void clear() {
        ...
        int n = list.size();
        for (int i = 0; i < n; i++) {
            servletRequest.removeAttribute(list.get(i));
        }
    ...
    public boolean containsKey(Object key) {
        ...
        return (servletRequest.getAttribute((String) key) != null);
    ...
    public boolean containsValue(Object value) {
        ...
        while (names.hasMoreElements()) {
            ...
            if (value.equals(servletRequest.getAttribute(name)))
                return (true);
        }
        return (false);
    ...
    public Set<Map.Entry<String, Object>> entrySet() {
        ...
        while (names.hasMoreElements()) {
            String name = (String) names.nextElement();
            results.add(new MapEntry<String, Object>(name, servletRequest.getAttribute(name)));
        }
        return (results);
    ...
    public boolean equals(Object object) {
        ...
        return (servletRequest.equals(object));
    ...
    public Collection<Object> values() {
        ...
        while (names.hasMoreElements()) {
            String name = (String) names.nextElement();
            results.add(servletRequest.getAttribute(name));
        }
        return (results);
