...
/**
 * <strong>HttpSessionScope</strong> is a specialized <code>Scope</code>
...
public class HttpSessionScope extends BaseScope {
    ...
    /**
     * Construct a HttpSessionScope associated with the specified
     * HttpSession.
     *
     * @param httpSession The associated HttpSession
     */
    public HttpSessionScope(HttpSession httpSession) {
    ...
    public void clear() {
        ...
        int n = list.size();
        for (int i = 0; i < n; i++) {
            httpSession.removeAttribute(list.get(i));
        }
    ...
    public boolean containsValue(Object value) {
        ...
        while (names.hasMoreElements()) {
            ...
            if (value.equals(httpSession.getAttribute(name)))
                return (true);
        }
        return (false);
    ...
    public Set<Map.Entry<String, Object>> entrySet() {
        ...
        while (names.hasMoreElements()) {
            ...
            results.add(new MapEntry<String, Object>(name, httpSession.getAttribute(name)));
        }
        return (results);
    ...
    public boolean equals(Object object) {
        ...
        return (httpSession.equals(object));
    ...
    public Object put(String key, Object bean) {
        ...
        if (old != null) {
            httpSession.setAttribute(key, bean);
    ...
    public Collection<Object> values() {
        ...
        while (names.hasMoreElements()) {
            String name = (String) names.nextElement();
            results.add(httpSession.getAttribute(name));
        }
        return (results);
